...
class CMMCore:
    ...
    def setStorageDevice(self, storageLabel: str) -> None: ...
    def getStorageDevice(self) -> str: ...
    def createDataset(
        self,
        path: str,
        name: str,
        shape: Sequence[int],
        pixelType: StorageDataType,
        meta: str,
    ) -> str: ...
    def isDatasetOpen(self, dataset: str) -> bool: ...
    def getDatasetPath(self, dataset: str) -> str: ...
    def getDatasetShape(self, dataset: str) -> list[int]: ...
    def getDatasetPixelType(self, dataset: str) -> StorageDataType: ...
    def getSummaryMeta(self, dataset: str) -> str: ...
    def snapAndSave(
        self, dataset: str, coordinates: Sequence[int], meta: str
    ) -> None: ...
...
class StorageDataType(enum.IntEnum):
    StorageDataType_UNKNOWN = 0
    StorageDataType_GRAY8 = 1
    StorageDataType_GRAY16 = 2
    StorageDataType_RGB32 = 3
