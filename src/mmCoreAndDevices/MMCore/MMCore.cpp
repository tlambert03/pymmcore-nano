...
void CMMCore::setStorageDevice(const char* storageLabel) noexcept(false)
{
...
std::string CMMCore::getStorageDevice() noexcept(false)
{
 ...
 */
std::string CMMCore::createDataset(const char* path, const char* name, const std::vector<long>& shape, MM::StorageDataType pixelType, const char* meta) noexcept(false)
{
 ...
 */
void CMMCore::closeDataset(const char* handle) noexcept(false)
{
   std::shared_ptr<StorageInstance> storage = currentStorage_.lock();
   if (storage)
   {
 ...
 */
std::string CMMCore::loadDataset(const char* path) noexcept(false)
{
   std::shared_ptr<StorageInstance> storage = currentStorage_.lock();
   if (storage)
   {
...
std::string CMMCore::getDatasetPath(const char* handle) noexcept(false)
{
   return std::string();
}
...
std::vector<long> CMMCore::getDatasetShape(const char* handle) noexcept(false)
{
   std::shared_ptr<StorageInstance> storage = currentStorage_.lock();
   if (storage)
   {
...
MM::StorageDataType CMMCore::getDatasetPixelType(const char* handle) noexcept(false)
{
   std::shared_ptr<StorageInstance> storage = currentStorage_.lock();
   if (storage)
   {
 ...
 */
void CMMCore::addImage(const char* handle, int sizeInBytes, const STORAGEIMG pixels, const std::vector<long>& coordinates, const char* imageMeta) noexcept(false)
{
   std::shared_ptr<StorageInstance> storage = currentStorage_.lock();
   if (storage)
   {
 ...
 * \param imageMeta - serialized JSON with image specific metadata
 */
void CMMCore::addImage(const char* handle, int sizeInShorts, const STORAGEIMG16 pixels, const std::vector<long>& coordinates, const char* imageMeta) noexcept(false)
{
   std::shared_ptr<StorageInstance> storage = currentStorage_.lock();
   if (storage)
   {
 ...
 */
void CMMCore::configureDimension(const char* handle, int dimension, const char* name, const char* meaning) noexcept(false)
{
   std::shared_ptr<StorageInstance> storage = currentStorage_.lock();
   if (storage)
   {
 ...
 */
void CMMCore::configureCoordinate(const char* handle, int dimension, int coordinate, const char* name) noexcept(false)
{
   std::shared_ptr<StorageInstance> storage = currentStorage_.lock();
   if (storage)
   {
 ...
 */
std::string CMMCore::getSummaryMeta(const char* handle) noexcept(false)
{
   std::shared_ptr<StorageInstance> storage = currentStorage_.lock();
   if (storage)
   {
 ...
 */
std::string CMMCore::getImageMeta(const char* handle, const std::vector<long>& coordinates) noexcept(false)
{
   std::shared_ptr<StorageInstance> storage = currentStorage_.lock();
   if (storage)
   {
 ...
 * \return - image pixels
 */
STORAGEIMGOUT CMMCore::getImage(const char* handle, const std::vector<long>& coordinates) noexcept(false)
{
   std::shared_ptr<StorageInstance> storage = currentStorage_.lock();
   if (storage)
   {
 ...
 */
void CMMCore::saveNextImage(const char* handle, const std::vector<long>& coordinates, const char* imageMeta) noexcept(false)
{
 ...
 */
void CMMCore::attachStorageToCircularBuffer(const char* handle)  noexcept(false)
{
   // TODO
}
